...
import "./chunk-673N2VGB.js";
import {
  ens_normalize
} from "./chunk-RQGXGONU.js";
import "./chunk-GYX3CSLA.js";
...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-BWPCPCTO.js";
import "./chunk-S7AE2N54.js";
import "./chunk-RYWDNK22.js";
import "./chunk-X2XASJAL.js";
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-IJRTXU24.js";
import "./chunk-IGKHQNQG.js";
import "./chunk-45S3XKLS.js";
import {
  Field,
  FpInvertBatch,
  FpSqrtEven,
...
import {
  ...
  utf8ToBytes,
  validateObject
} from "./chunk-THFMKB3W.js";
import {
  useQuery
} from "./chunk-NDKFV3V3.js";
import {
  require_react_dom
} from "./chunk-J7AZIXCB.js";
import {
  require_jsx_runtime
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-G3BXUWU4.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-OKUUS7GM.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-J247IS43.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-LNCPEJFN.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-DAH4ANYB.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-P2YF2FF6.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-FN3HTWXP.js");
