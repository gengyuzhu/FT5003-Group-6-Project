...
var ICONS = {
  add: async () => (await import("./add-OM7X5E7R.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-NFTGNSAO.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-PTMPVQXR.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-7NRNAR4F.js")).appStoreSvg,
  apple: async () => (await import("./apple-RO275WHI.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-U6NNNUAX.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-2AF7DE6H.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-HPX46NNI.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-WRHTBPK7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-LQKZLELV.js")).bankSvg,
  browser: async () => (await import("./browser-5HNJEGM7.js")).browserSvg,
  card: async () => (await import("./card-K2WH4WM5.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-TPYWSEYE.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-VFWPFYE2.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-4W5GBXQ3.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-DLLTUB4B.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-QOQX6ISW.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-T3KVJMS7.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-Z44FJUE7.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-5SLEEGYX.js")).clockSvg,
  close: async () => (await import("./close-PY4C3MAO.js")).closeSvg,
  compass: async () => (await import("./compass-QZGEOHHV.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-G5UCKLDH.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-YMVOMKFE.js")).copySvg,
  cursor: async () => (await import("./cursor-J4YJO4BX.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-BUQOMRRU.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-IL5WF7SM.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-N2R4NPVO.js")).disconnectSvg,
  discord: async () => (await import("./discord-XMZRDPL4.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-OLZWBQKS.js")).etherscanSvg,
  extension: async () => (await import("./extension-26L6AF2N.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-45N4U4YN.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-DCNMDF7Q.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-2MXQRX67.js")).farcasterSvg,
  filters: async () => (await import("./filters-7EPMCWEK.js")).filtersSvg,
  github: async () => (await import("./github-RW4JEUIO.js")).githubSvg,
  google: async () => (await import("./google-YIQEASNT.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-BZYS6KG4.js")).helpCircleSvg,
  image: async () => (await import("./image-E6PCUPRY.js")).imageSvg,
  id: async () => (await import("./id-U2RQXX55.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-VA4Z425S.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-6AE2W24Q.js")).lightbulbSvg,
  mail: async () => (await import("./mail-V7ZERXSY.js")).mailSvg,
  mobile: async () => (await import("./mobile-PJII6XAG.js")).mobileSvg,
  more: async () => (await import("./more-XMWROSXN.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-ESLXBNWY.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-TGW4MSUR.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-O7QC5V2Z.js")).offSvg,
  playStore: async () => (await import("./play-store-5CP6Y7HC.js")).playStoreSvg,
  plus: async () => (await import("./plus-YQTNA5O5.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-Z32WDNTB.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-EUK6CUUQ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-HBJWYFQZ.js")).refreshSvg,
  search: async () => (await import("./search-GTTHCOTP.js")).searchSvg,
  send: async () => (await import("./send-D2SNTBQI.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-KBBBZJRR.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-5U2JFGSR.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-I6KAXJFF.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-Y46WAQM4.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-722GEJIM.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-5BVE5QPG.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-W7EN3372.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-HVG356H3.js")).twitchSvg,
  twitter: async () => (await import("./x-QDSIDBDT.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-3MV7IUDH.js")).twitterIconSvg,
  verify: async () => (await import("./verify-SDIWSYNK.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-K4ZNWLHL.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-CGNP5DYI.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-L2QWQAU6.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-L2QWQAU6.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-L2QWQAU6.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-PNVDGVJB.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-RCCQKVIP.js")).warningCircleSvg,
  x: async () => (await import("./x-QDSIDBDT.js")).xSvg,
  info: async () => (await import("./info-G74UN64A.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-KUIQ4Y4O.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-L4WQ547J.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-F75JMYG4.js.map
